...
% Our Company Macro's
\newcommand{\UGELongVersion}{$UGELongVersion$}
\newcommand{\UGEShortVersion}{$UGEShortVersion$}
\newcommand{\UGEFullName}{$UGEFullName$}
\newcommand{\UGEShortName}{$UGEShortName$}
...
\includegraphics[width=0.15\textwidth]{./univa-400x200.png}~\\[1cm]
...
\begin{center}
Copyright \copyright 2012--\the\year\ $company$.
All rights reserved.
\end{center}
\end{minipage}
