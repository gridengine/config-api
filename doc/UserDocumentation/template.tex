...
\usepackage{array} % provides \arraybackslash used in pandoc-generated table columns
\usepackage{calc} % provides \real{} used for pandoc column width calculations
\usepackage{booktabs}
...
%\includegraphics[width=0.15\textwidth]{siemens-logo.png}~\\[1cm]
\includegraphics{siemens-logo.png}~\\[1cm]
