...
# 8.7.4
UGE_RELEASE_OBJECT_MAP['8.7.4prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.7.3'])
UGE_RELEASE_OBJECT_MAP['8.7.4'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.7.3'])

# 8.7.5
UGE_RELEASE_OBJECT_MAP['8.7.5prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.7.4'])
