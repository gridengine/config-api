...
# 8.6.11
UGE_RELEASE_OBJECT_MAP['8.6.11prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.10'])
UGE_RELEASE_OBJECT_MAP['8.6.11alpha1'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.10'])
UGE_RELEASE_OBJECT_MAP['8.6.11'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.10'])

# 8.6.12
UGE_RELEASE_OBJECT_MAP['8.6.12prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.11'])
UGE_RELEASE_OBJECT_MAP['8.6.12'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.11'])

# 8.6.13
UGE_RELEASE_OBJECT_MAP['8.6.13prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.12'])
UGE_RELEASE_OBJECT_MAP['8.6.13'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.12'])

# 8.6.14
UGE_RELEASE_OBJECT_MAP['8.6.14prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.13'])
UGE_RELEASE_OBJECT_MAP['8.6.14'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.13'])

# 8.6.15
UGE_RELEASE_OBJECT_MAP['8.6.15prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.14'])
UGE_RELEASE_OBJECT_MAP['8.6.15'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.14'])

# 8.6.16
UGE_RELEASE_OBJECT_MAP['8.6.16prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.15'])
UGE_RELEASE_OBJECT_MAP['8.6.16'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.15'])

# 8.6.17
UGE_RELEASE_OBJECT_MAP['8.6.17prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.16'])
UGE_RELEASE_OBJECT_MAP['8.6.17'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.16'])

# 8.6.18
UGE_RELEASE_OBJECT_MAP['8.6.18'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.17'])

# 8.6.19
UGE_RELEASE_OBJECT_MAP['8.6.19prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.18'])
UGE_RELEASE_OBJECT_MAP['8.6.19'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.18'])

# 8.6.20
UGE_RELEASE_OBJECT_MAP['8.6.20prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.6.19'])
