...
# 8.9.1
UGE_RELEASE_OBJECT_MAP['8.9.1prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.9.0'])
UGE_RELEASE_OBJECT_MAP['8.9.1'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.9.0'])

# 8.10.0
UGE_RELEASE_OBJECT_MAP['8.10.0prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.9.1'])
UGE_RELEASE_OBJECT_MAP['8.10.0beta'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.9.1'])
UGE_RELEASE_OBJECT_MAP['8.10.0'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.9.1'])

# 8.11.0
UGE_RELEASE_OBJECT_MAP['8.11.0prealpha'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.10.0'])
UGE_RELEASE_OBJECT_MAP['8.11.0'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.10.0'])

# 8.12.0
UGE_RELEASE_OBJECT_MAP['8.12.0pre'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.11.0'])
UGE_RELEASE_OBJECT_MAP['8.12.0'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.11.0'])

# 8.12.1
UGE_RELEASE_OBJECT_MAP['8.12.1pre'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.12.0'])
UGE_RELEASE_OBJECT_MAP['8.12.1'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.12.0'])

# 8.13.0
UGE_RELEASE_OBJECT_MAP['8.13.0pre'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.12.1'])
UGE_RELEASE_OBJECT_MAP['8.13.0'] = copy.copy(UGE_RELEASE_OBJECT_MAP['8.12.1'])
